...
export class RoomController{
    ...
    constructor(){
        ...
        this.copyButton.addEventListener('click', this.onCopyButtonPressed.bind(this));
    ...
    showSnackBar(): void{
        if (this.snackbar){
            ...
            setTimeout(() => {
                if (this.snackbar) this.snackbar.className = this.snackbar.className.replace('show', '')
            }, 3000);
        }
    }
    ...
    updatePlayerList(playerNames: { [socketId: string]: string}):
        void {
